...
exports.addExpToLvl = exports.calculateExpToNextLevel = exports.resetUnitForLegendary = void 0;
const resetUnitForLegendary = (lvl, exp) => {
    return Math.max(1, Math.floor(lvl / 2));
};
exports.resetUnitForLegendary = resetUnitForLegendary;
const calculateExpToNextLevel = (level) => 100 * Math.pow(2, level - 1);
exports.calculateExpToNextLevel = calculateExpToNextLevel;
const addExpToLvl = (lvl, currExp, gainExp) => {
    let newLevel = lvl;
    let newExp = currExp + gainExp;
    let leveledUp = false;
    while (newExp >= (0, exports.calculateExpToNextLevel)(newLevel)) {
        newExp -= (0, exports.calculateExpToNextLevel)(newLevel);
        newLevel++;
        leveledUp = true;
    }
    return { newLevel, newExp };
};
exports.addExpToLvl = addExpToLvl;
